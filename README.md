...
[![Build Status](https://travis-ci.org/Landswap/uniswap-frontend.svg)](https://travis-ci.org/Landswap/uniswap-frontend)
...
- Website: [landswap.io](https://landswap.io/)

- Twitter: [@LandSwap](https://twitter.com/LandSwap)
- Reddit: [/r/Landswap](https://www.reddit.com/r/LandSwap/)
- Email: [info@landswap.io](mailto:info@landswap.io)
- Discord: [Landswap](https://discord.gg/UYdfWJm)
  
## Run Landswap Locally
 
1. Download and unzip the `build.zip` file from the latest release in the [Releases tab](https://github.com/LandSwap/uniswap-frontend/releases/latest).
